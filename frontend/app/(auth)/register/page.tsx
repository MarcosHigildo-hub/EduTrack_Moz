...
export default function RegistoPage() {
  ...
  const schema = z.object({
    ...
    codigo: z.string().min(3, "Email ou código obrigatório"),
    ...
    <div className="min-h-screen flex items-center justify-center mx-auto">
      <Card className="w-full max-w-md border-t-4 border-blue-600 shadow-xl">
        <div className="p-6 space-y-6">
          {/* === TÍTULO === */}
          <h1 className="text-3xl font-bold text-center text-gray-800">Registar</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full bg-blue-600  text-white font-bold py-3 text-lg"
            >
              Criar Conta
            </Button>
          </form>
